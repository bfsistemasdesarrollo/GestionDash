...
- Cree un proyecto de React con create-vite: `npm init --yes vite@latest gestiondash.client -- --template=react  --no-rolldown --no-immediate`.
...
- Crear archivo de proyecto (`gestiondash.client.esproj`).
